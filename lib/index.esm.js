...
function AudioVisualizer(props) {
    ...
    if (window.AudioContext || window.webkitAudioContext) {
        return React.createElement(RealAudioVisualizer, __assign({}, props));
    }
    else {
        return React.createElement(React.Fragment, null, "Your browser doesn't support audio contexts");
    }
}
