...
function RealAudioVisualizer(_a) {
    var audio = _a.audio, _b = _a.amplitude, amplitude = _b === void 0 ? 1 : _b, props = __rest(_a, ["audio", "amplitude"]);
    var _c = useMeasure__default["default"](), container = _c[0], bounds = _c[1];
    ...
    React.useEffect(function () {
        ...
        // @ts-expect-error: webkitAudioContext may be undefined.
    ...
    return (React__default["default"].createElement("div", __assign({ ref: container }, props),
        React__default["default"].createElement("canvas", { ref: canvas, height: bounds.height, width: bounds.width })));
}
// This is an wrapper to RealAudioVisualizer.
function AudioVisualizer(props) {
    // @ts-expect-error: webkitAudioContext may be undefined.
    if (window.AudioContext || window.webkitAudioContext) {
        return React__default["default"].createElement(RealAudioVisualizer, __assign({}, props));
    }
    else {
        return React__default["default"].createElement(React__default["default"].Fragment, null, "Your browser doesn't support audio contexts");
    }
}
